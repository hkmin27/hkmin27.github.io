/* @ts-self-types="./continued_fractions.d.ts" */
 ...
 */
export function continued_fractions(p, q) {
    const ret = wasm.continued_fractions(p, q);
    if (ret[3]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./continued_fractions_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('continued_fractions_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
