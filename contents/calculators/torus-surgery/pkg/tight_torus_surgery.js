/* @ts-self-types="./tight_torus_surgery.d.ts" */
 ...
 */
export function tight_torus_surgery(p, q, a, b) {
    const ret = wasm.tight_torus_surgery(p, q, a, b);
    if (ret[3]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tight_torus_surgery_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
