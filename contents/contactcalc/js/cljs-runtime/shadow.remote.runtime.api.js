...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36565 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36565(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_36573 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_36573(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_36575 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_36575(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_36576 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_36576(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36580 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_36580(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36582 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_36582(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__36560,callback){
var map__36561 = p__36560;
var map__36561__$1 = cljs.core.__destructure_map(map__36561);
var input = map__36561__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36561__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36561__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
