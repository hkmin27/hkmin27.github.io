...
var G__31033 = o;
goog.object.set(G__31033,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__31056__delegate = function (args){
...
while (G__31057__i < G__31057__a.length) {G__31057__a[G__31057__i] = arguments[G__31057__i + 0]; ++G__31057__i;}
  args = new cljs.core.IndexedSeq(G__31057__a,0,null);
} 
return G__31056__delegate.call(this,args);};
G__31056.cljs$lang$maxFixedArity = 0;
G__31056.cljs$lang$applyTo = (function (arglist__31058){
var args = cljs.core.seq(arglist__31058);
return G__31056__delegate(args);
});
...
var G__31039 = o;
goog.object.set(G__31039,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31061__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__31061 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__31062__i < G__31062__a.length) {G__31062__a[G__31062__i] = arguments[G__31062__i + 0]; ++G__31062__i;}
  args = new cljs.core.IndexedSeq(G__31062__a,0,null);
} 
return G__31061__delegate.call(this,args);};
G__31061.cljs$lang$maxFixedArity = 0;
G__31061.cljs$lang$applyTo = (function (arglist__31063){
var args = cljs.core.seq(arglist__31063);
return G__31061__delegate(args);
});
G__31061.cljs$core$IFn$_invoke$arity$variadic = G__31061__delegate;
return G__31061;
})()
;
} else {
...
var G__31040 = props;
var G__31040__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31040,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31040);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31040__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31041 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31041,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31041;
}
})(),id_class);
...
var G__31042 = (cljs.core.count(argv) - first_child);
switch (G__31042) {
case (0):
...
var vec__31043 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31043,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31043,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31043,(2),null);
...
var temp__5739__auto___31083 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___31083 == null)){
} else {
var key_31084 = temp__5739__auto___31083;
(jsprops.key = key_31084);
}
...
var temp__5739__auto___31085 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___31085 == null)){
} else {
var key_31086 = temp__5739__auto___31085;
(jsprops.key = key_31086);
}
...
var temp__5739__auto___31091 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___31091 == null)){
} else {
var key_31092 = temp__5739__auto___31091;
(jsprops.key = key_31092);
}
...
var temp__5739__auto___31098 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___31098 == null)){
} else {
var key_31099 = temp__5739__auto___31098;
(jsprops.key = key_31099);
}
...
var temp__5739__auto___31104 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___31104 == null)){
} else {
var key_31105 = temp__5739__auto___31104;
(jsprops.key = key_31105);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31046_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31046_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31047 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31047,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31047,(1),null);
...
break;
default:
var G__31108 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__31109 = compiler;
v = G__31108;
compiler = G__31109;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31053 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31053 = (function (opts,id,fn_to_element,meta31054){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31053.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31055,meta31054__$1){
var self__ = this;
var _31055__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31053(self__.opts,self__.id,self__.fn_to_element,meta31054__$1));
}));

(reagent.impl.template.t_reagent$impl$template31053.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31055){
var self__ = this;
var _31055__$1 = this;
return self__.meta31054;
}));

(reagent.impl.template.t_reagent$impl$template31053.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31053.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31053.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31053.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31053.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta31054","meta31054",-154407141,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31053.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31053.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31053");

(reagent.impl.template.t_reagent$impl$template31053.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template31053");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31053.
 */
reagent.impl.template.__GT_t_reagent$impl$template31053 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31053(opts__$1,id__$1,fn_to_element__$1,meta31054){
return (new reagent.impl.template.t_reagent$impl$template31053(opts__$1,id__$1,fn_to_element__$1,meta31054));
});

}

return (new reagent.impl.template.t_reagent$impl$template31053(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
