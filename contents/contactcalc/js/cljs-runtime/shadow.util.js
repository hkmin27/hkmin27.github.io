...
var len__4771__auto___36397 = arguments.length;
var i__4772__auto___36398 = (0);
while(true){
if((i__4772__auto___36398 < len__4771__auto___36397)){
args_arr__4792__auto__.push((arguments[i__4772__auto___36398]));

var G__36399 = (i__4772__auto___36398 + (1));
i__4772__auto___36398 = G__36399;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq36365){
var G__36366 = cljs.core.first(seq36365);
var seq36365__$1 = cljs.core.next(seq36365);
var G__36367 = cljs.core.first(seq36365__$1);
var seq36365__$2 = cljs.core.next(seq36365__$1);
var G__36368 = cljs.core.first(seq36365__$2);
var seq36365__$3 = cljs.core.next(seq36365__$2);
var G__36369 = cljs.core.first(seq36365__$3);
var seq36365__$4 = cljs.core.next(seq36365__$3);
var G__36370 = cljs.core.first(seq36365__$4);
var seq36365__$5 = cljs.core.next(seq36365__$4);
var G__36371 = cljs.core.first(seq36365__$5);
var seq36365__$6 = cljs.core.next(seq36365__$5);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36366,G__36367,G__36368,G__36369,G__36370,G__36371,seq36365__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__36382){
var vec__36383 = p__36382;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36383,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36383,(1),null);
