...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__30919 = c;
var G__30919__$1 = (((G__30919 == null))?null:G__30919.prototype);
if((G__30919__$1 == null)){
return null;
} else {
return G__30919__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__30921 = c;
var G__30921__$1 = (((G__30921 == null))?null:G__30921.prototype);
if((G__30921__$1 == null)){
return null;
} else {
return G__30921__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__31024__delegate = function (args){
...
var G__31024 = function (var_args){
var args = null;
...
while (G__31025__i < G__31025__a.length) {G__31025__a[G__31025__i] = arguments[G__31025__i + 0]; ++G__31025__i;}
  args = new cljs.core.IndexedSeq(G__31025__a,0,null);
} 
return G__31024__delegate.call(this,args);};
G__31024.cljs$lang$maxFixedArity = 0;
G__31024.cljs$lang$applyTo = (function (arglist__31026){
var args = cljs.core.seq(arglist__31026);
return G__31024__delegate(args);
});
...
var or__4160__auto__ = (function (){var G__30936 = c;
var G__30936__$1 = (((G__30936 == null))?null:G__30936.constructor);
if((G__30936__$1 == null)){
return null;
} else {
return G__30936__$1.displayName;
}
})();
...
var G__30937 = c;
var G__30937__$1 = (((G__30937 == null))?null:G__30937.constructor);
if((G__30937__$1 == null)){
return null;
} else {
return G__30937__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__30938 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__30939 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__30939);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__30938);
}});
...
var c = this;
var G__31002_31030 = goog.object.get(c,"cljsRatom");
if((G__31002_31030 == null)){
} else {
reagent.ratom.dispose_BANG_(G__31002_31030);
}
...
var renders_31031 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_31032 = cljs.core.first(cljs.core.vals(renders_31031));
...
if((cljs.core.count(renders_31031) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_31031))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_31032)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_31032], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__31014 = o;
goog.object.set(G__31014,cljs.core.name(k),v);
...
var vec__31017 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31017,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31017,(1),null);
...
var G__31020 = goog.object.get(reagent_state,"cljsRatom");
if((G__31020 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__31020);
}
});
}),[]);
