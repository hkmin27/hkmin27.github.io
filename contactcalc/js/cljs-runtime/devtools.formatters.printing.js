...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31934){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31935,G__31936,seq31934__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31952_SHARP_){
return (!((cljs.core.meta(p1__31952_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31977__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31982){var _e__31443__auto__ = e31982;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e31984){var _e__31443__auto__ = e31984;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31990 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31991 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31991);

try{var map__31992 = opts;
var map__31992__$1 = cljs.core.__destructure_map(map__31992);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31992__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31990);
}});
...
var temp__5733__auto___32031 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___32031)){
var managed_print_level_32032 = temp__5733__auto___32031;
var _STAR_print_level_STAR__orig_val__32008_32033 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32009_32034 = managed_print_level_32032;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32009_32034);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32004_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32004_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32008_32033);
}} else {
job_fn();
}
