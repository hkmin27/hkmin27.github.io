...
{l:"-(n1+n2)",r:"(-n1-n2)"},{l:"(n1^n2)^n3",r:"(n1^(n2*n3))"},{l:"-(-n1/n2)",r:"(n1/n2)"},{l:"-(n1/n2)",r:"(-n1/n2)"}],rulesSucDiv=[{l:"(n1/(n2/n3))",r:"((n1*n3)/n2)"},{l:"(n1/n2/n3)",r:"(n1/(n2*n3))"}];var JSCompiler_object_inline_firstRules_884=oldRules.concat(rulesFirst,rulesSucDiv);var JSCompiler_object_inline_distrDivRules_885=[{l:"(n1/n2 + n3/n4)",r:"((n1*n4 + n3*n2)/(n2*n4))"},{l:"(n1/n2 + n3)",r:"((n1 + n3*n2)/n2)"},{l:"(n1 + n2/n3)",r:"((n1*n3 + n2)/n3)"}];rulesFirst=oldRules.concat(rulesFirst);
var JSCompiler_object_inline_finalRules_888=[simplifyCore,{l:"n*-n",r:"-n^2"},{l:"n*n",r:"n^2"},simplifyConstant,{l:"n*-n^n1",r:"-n^(n1+1)"},{l:"n*n^n1",r:"n^(n1+1)"},{l:"n^n1*-n^n2",r:"-n^(n1+n2)"},{l:"n^n1*n^n2",r:"n^(n1+n2)"},{l:"n^n1*-n",r:"-n^(n1+1)"},{l:"n^n1*n",r:"n^(n1+1)"},{l:"n^n1/-n",r:"-n^(n1-1)"},{l:"n^n1/n",r:"n^(n1-1)"},{l:"n/-n^n1",r:"-n^(1-n1)"},{l:"n/n^n1",r:"n^(1-n1)"},{l:"n^n1/-n^n2",r:"n^(n1-n2)"},{l:"n^n1/n^n2",r:"n^(n1-n2)"},{l:"n1+(-n2*n3)",r:"n1-n2*n3"},{l:"v*(-c)",r:"-c*v"},
{l:"n1+-n2",r:"n1-n2"},{l:"v*c",r:"c*v"},{l:"(n1^n2)^n3",r:"(n1^(n2*n3))"}];scope=polynomial(expr,scope,!0,JSCompiler_object_inline_firstRules_884);oldRules=scope.variables.length;expr=scope.expression;if(1<=oldRules){expr=expandPower(expr);var eDistrDiv=!0,redoInic=!1;for(expr=simplify(expr,JSCompiler_object_inline_firstRules_884,{},{exactFractions:!1});;){JSCompiler_object_inline_firstRules_884=eDistrDiv?JSCompiler_object_inline_distrDivRules_885:rulesSucDiv;expr=simplify(expr,JSCompiler_object_inline_firstRules_884);
eDistrDiv=!eDistrDiv;JSCompiler_object_inline_firstRules_884=expr.toString();if(JSCompiler_object_inline_firstRules_884===sBefore)break;redoInic=!0;var sBefore=JSCompiler_object_inline_firstRules_884}redoInic&&(expr=simplify(expr,rulesFirst,{},{exactFractions:!1}));expr=simplify(expr,JSCompiler_object_inline_finalRules_888,{},{exactFractions:!1})}rulesSucDiv=[];JSCompiler_object_inline_distrDivRules_885={};"OperatorNode"===expr.type&&expr.isBinary()&&"/"===expr.op?(1===oldRules&&(expr.args[0]=polyToCanonical(expr.args[0],
rulesSucDiv),expr.args[1]=polyToCanonical(expr.args[1])),detailed&&(JSCompiler_object_inline_distrDivRules_885.numerator=expr.args[0],JSCompiler_object_inline_distrDivRules_885.denominator=expr.args[1])):(1===oldRules&&(expr=polyToCanonical(expr,rulesSucDiv)),detailed&&(JSCompiler_object_inline_distrDivRules_885.numerator=expr,JSCompiler_object_inline_distrDivRules_885.denominator=null));if(!detailed)return expr;JSCompiler_object_inline_distrDivRules_885.coefficients=rulesSucDiv;JSCompiler_object_inline_distrDivRules_885.variables=
scope.variables;JSCompiler_object_inline_distrDivRules_885.expression=expr;return JSCompiler_object_inline_distrDivRules_885}})});exports.createRationalize=require}
