...
var o31421 = temp__5733__auto__;
var temp__5733__auto____$1 = (o31421["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o31422 = temp__5733__auto____$1;
return (o31422["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30950__auto__ = f;
return (o__30950__auto__["toString"]).call(o__30950__auto__);
} else {
return "";
}
}catch (e31427){var _ = e31427;
return "";
}});
...
try{var o__30950__auto___31622 = t;
(o__30950__auto___31622["cljs$lang$ctorPrWriter"]).call(o__30950__auto___31622,t,writer);
}catch (e31441){var __31623 = e31441;
}
...
var char_code = (function (){var o__30950__auto__ = (new String(char$));
return (o__30950__auto__["charCodeAt"]).call(o__30950__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30950__auto__ = String;
return (o__30950__auto__["fromCharCode"]).call(o__30950__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31450 = num_code;
switch (G__31450) {
case (1):
return (185);
...
var o__30950__auto__ = String;
return (o__30950__auto__["fromCharCode"]).call(o__30950__auto__,superscript_code);
});
/**
...
}catch (e31453){var _e__30957__auto__ = e31453;
return false;
}})())){
...
var vec__31454 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31454,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31464){
var vec__31465 = p__31464;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31465,(0),null);
...
var G__31641 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31642 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31641;
remaining_tokens = G__31642;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31461){
var G__31462 = cljs.core.first(seq31461);
var seq31461__$1 = cljs.core.next(seq31461);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31462,seq31461__$1);
}));
...
var vec__31479 = cljs.core.split_with((function (p1__31478_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31478_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31479,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31479,(1),null);
...
var vec__31489 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31489,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31489,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31650 = cljs.core.rest(remaining_tokens);
var G__31651 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31650;
name_tokens = G__31651;
continue;
} else {
...
var vec__31494 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31494,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31494,(1),null);
var vec__31497 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31497,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31497,(1),null);
var vec__31500 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(3),null);
...
var vec__31508 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31508,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__31511 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31511,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31511,(1),null);
var vec__31514 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31514,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31514,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__31519 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__31519) : devtools.munging.parse_fn_info_deep.call(null,G__31519));
})()));
}
} else {
return fn_info;
...
var G__31679 = (arity + (1));
var G__31680 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31534){
var vec__31535 = p__31534;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31535,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31535,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31539_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__31539_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31540_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__31540_SHARP_);
}),sorted_infos);
...
var i__4772__auto___31694 = (0);
while(true){
if((i__4772__auto___31694 < len__4771__auto___31693)){
args__4777__auto__.push((arguments[i__4772__auto___31694]));

var G__31695 = (i__4772__auto___31694 + (1));
i__4772__auto___31694 = G__31695;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31546){
var vec__31547 = p__31546;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31547,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31544){
var G__31545 = cljs.core.first(seq31544);
var seq31544__$1 = cljs.core.next(seq31544);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31545,seq31544__$1);
}));
...
var map__31565 = options;
var map__31565__$1 = cljs.core.__destructure_map(map__31565);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31565__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31565__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31565__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31565__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31566 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31566,(5),null);
...
var o__30950__auto__ = f;
return (o__30950__auto__["getBasis"]).call(o__30950__auto__);
});
/**
...
}catch (e31572){var _e__30957__auto__ = e31572;
...
var G__31702 = (obj[cljs.core.first(path)]);
var G__31703 = cljs.core.rest(path);
obj = G__31702;
path = G__31703;
continue;
} else {
...
var _STAR_ = (function (accum,p__31584){
var vec__31585 = p__31584;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31585,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31585,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31591){
var vec__31592 = p__31591;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31592,(2),null);
...
var post_process = (function (p__31597){
var vec__31598 = p__31597;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31598,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31598,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31595_SHARP_){
return (obj[cljs.core.first(p1__31595_SHARP_)]);
}),sorted_matches);
