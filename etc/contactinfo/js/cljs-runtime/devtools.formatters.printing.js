...
var len__4771__auto___31761 = arguments.length;
var i__4772__auto___31762 = (0);
while(true){
if((i__4772__auto___31762 < len__4771__auto___31761)){
args__4777__auto__.push((arguments[i__4772__auto___31762]));

var G__31763 = (i__4772__auto___31762 + (1));
i__4772__auto___31762 = G__31763;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31672){
var G__31673 = cljs.core.first(seq31672);
var seq31672__$1 = cljs.core.next(seq31672);
var G__31674 = cljs.core.first(seq31672__$1);
var seq31672__$2 = cljs.core.next(seq31672__$1);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31673,G__31674,seq31672__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31690_SHARP_){
return (!((cljs.core.meta(p1__31690_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31707__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31719){var _e__30957__auto__ = e31719;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e31721){var _e__30957__auto__ = e31721;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31733 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31734 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31734);

try{var map__31741 = opts;
var map__31741__$1 = cljs.core.__destructure_map(map__31741);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31741__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31733);
}});
...
var temp__5733__auto___31771 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___31771)){
var managed_print_level_31772 = temp__5733__auto___31771;
var _STAR_print_level_STAR__orig_val__31759_31773 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31760_31774 = managed_print_level_31772;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31760_31774);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31758_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31758_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31759_31773);
}} else {
job_fn();
}
