...
8,wordSize);case "hex":return formatBigNumberToBase(value,16,wordSize);case "auto":notation=options&&void 0!==options.lowerExp?options.lowerExp:-3;options=options&&void 0!==options.upperExp?options.upperExp:5;if(value.isZero())return"0";wordSize=value.toSignificantDigits(precision);var exp=wordSize.e;return(exp>=notation&&exp<options?wordSize.toFixed():toExponential(value,precision)).replace(/((\.\d*?)(0+))($|e)/,function(JSCompiler_OptimizeArgumentsArray_p5,JSCompiler_OptimizeArgumentsArray_p6,JSCompiler_OptimizeArgumentsArray_p7,
JSCompiler_OptimizeArgumentsArray_p8,JSCompiler_OptimizeArgumentsArray_p9){return"."!==JSCompiler_OptimizeArgumentsArray_p7?JSCompiler_OptimizeArgumentsArray_p7+JSCompiler_OptimizeArgumentsArray_p9:JSCompiler_OptimizeArgumentsArray_p9});default:throw Error('Unknown notation "'+notation+'". Choose "auto", "exponential", "fixed", "bin", "oct", or "hex.');}};exports.toEngineering=toEngineering;exports.toExponential=toExponential;exports.toFixed=function(value,precision){return value.toFixed(precision)};
var _number=require("module$node_modules$mathjs$lib$cjs$utils$number")}
