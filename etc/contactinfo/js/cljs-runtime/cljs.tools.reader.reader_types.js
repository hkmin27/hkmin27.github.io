...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_34503 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_34503(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_34504 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_34504(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34505 = (function (reader,ch){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34505(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34506 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34506(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34507 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34507(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34508 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34508(reader);
}
});
...
var G__34526 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__34527 = s.append(c);
c = G__34526;
s = G__34527;
continue;
}
