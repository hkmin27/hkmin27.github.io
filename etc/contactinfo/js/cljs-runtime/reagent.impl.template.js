...
var G__41815 = o;
goog.object.set(G__41815,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41935__delegate = function (args){
...
while (G__41936__i < G__41936__a.length) {G__41936__a[G__41936__i] = arguments[G__41936__i + 0]; ++G__41936__i;}
  args = new cljs.core.IndexedSeq(G__41936__a,0,null);
} 
return G__41935__delegate.call(this,args);};
G__41935.cljs$lang$maxFixedArity = 0;
G__41935.cljs$lang$applyTo = (function (arglist__41937){
var args = cljs.core.seq(arglist__41937);
return G__41935__delegate(args);
});
...
var G__41823 = o;
goog.object.set(G__41823,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__41938__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__41938 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__41939__i < G__41939__a.length) {G__41939__a[G__41939__i] = arguments[G__41939__i + 0]; ++G__41939__i;}
  args = new cljs.core.IndexedSeq(G__41939__a,0,null);
} 
return G__41938__delegate.call(this,args);};
G__41938.cljs$lang$maxFixedArity = 0;
G__41938.cljs$lang$applyTo = (function (arglist__41940){
var args = cljs.core.seq(arglist__41940);
return G__41938__delegate(args);
});
...
var G__41846 = props;
var G__41846__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41846,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41846);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41846__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41871 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41871,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41871;
}
})(),id_class);
...
var G__41898 = (cljs.core.count(argv) - first_child);
switch (G__41898) {
case (0):
...
var vec__41922 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41922,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41922,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41922,(2),null);
...
var temp__5739__auto___41947 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___41947 == null)){
} else {
var key_41948 = temp__5739__auto___41947;
(jsprops.key = key_41948);
}
...
var temp__5739__auto___41950 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___41950 == null)){
} else {
var key_41951 = temp__5739__auto___41950;
(jsprops.key = key_41951);
}
...
var temp__5739__auto___41952 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___41952 == null)){
} else {
var key_41953 = temp__5739__auto___41952;
(jsprops.key = key_41953);
}
...
var temp__5739__auto___41958 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___41958 == null)){
} else {
var key_41959 = temp__5739__auto___41958;
(jsprops.key = key_41959);
}
...
var temp__5739__auto___41965 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___41965 == null)){
} else {
var key_41966 = temp__5739__auto___41965;
(jsprops.key = key_41966);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41925_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41925_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41926 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41926,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41926,(1),null);
...
break;
default:
var G__41975 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__41976 = compiler;
v = G__41975;
compiler = G__41976;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41932 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41932 = (function (opts,id,fn_to_element,meta41933){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41932.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41934,meta41933__$1){
var self__ = this;
var _41934__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41932(self__.opts,self__.id,self__.fn_to_element,meta41933__$1));
}));

(reagent.impl.template.t_reagent$impl$template41932.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41934){
var self__ = this;
var _41934__$1 = this;
return self__.meta41933;
}));

(reagent.impl.template.t_reagent$impl$template41932.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41932.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41932.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41932.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41932.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta41933","meta41933",-945583541,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41932.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41932.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41932");

(reagent.impl.template.t_reagent$impl$template41932.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template41932");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41932.
 */
reagent.impl.template.__GT_t_reagent$impl$template41932 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41932(opts__$1,id__$1,fn_to_element__$1,meta41933){
return (new reagent.impl.template.t_reagent$impl$template41932(opts__$1,id__$1,fn_to_element__$1,meta41933));
});

}

return (new reagent.impl.template.t_reagent$impl$template41932(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
