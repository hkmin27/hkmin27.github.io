...
var len__4771__auto___34563 = arguments.length;
var i__4772__auto___34564 = (0);
while(true){
if((i__4772__auto___34564 < len__4771__auto___34563)){
args__4777__auto__.push((arguments[i__4772__auto___34564]));

var G__34565 = (i__4772__auto___34564 + (1));
i__4772__auto___34564 = G__34565;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq34509){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34510,G__34511,seq34509__$2);
}));
...
var args__4777__auto__ = [];
var len__4771__auto___34566 = arguments.length;
var i__4772__auto___34567 = (0);
while(true){
if((i__4772__auto___34567 < len__4771__auto___34566)){
args__4777__auto__.push((arguments[i__4772__auto___34567]));

var G__34568 = (i__4772__auto___34567 + (1));
i__4772__auto___34567 = G__34568;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq34512){
var G__34513 = cljs.core.first(seq34512);
var seq34512__$1 = cljs.core.next(seq34512);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34513,seq34512__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq34514){
var G__34515 = cljs.core.first(seq34514);
var seq34514__$1 = cljs.core.next(seq34514);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34515,seq34514__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq34516){
var G__34517 = cljs.core.first(seq34516);
var seq34516__$1 = cljs.core.next(seq34516);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34517,seq34516__$1);
}));
...
var args__4777__auto__ = [];
var len__4771__auto___34577 = arguments.length;
var i__4772__auto___34578 = (0);
while(true){
if((i__4772__auto___34578 < len__4771__auto___34577)){
args__4777__auto__.push((arguments[i__4772__auto___34578]));

var G__34579 = (i__4772__auto___34578 + (1));
i__4772__auto___34578 = G__34579;
continue;
} else {
}
break;
...
var init = (function (){var G__34542 = kind;
var G__34542__$1 = (((G__34542 instanceof cljs.core.Keyword))?G__34542.fqn:null);
switch (G__34542__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__34542__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq34538){
var G__34539 = cljs.core.first(seq34538);
var seq34538__$1 = cljs.core.next(seq34538);
var G__34540 = cljs.core.first(seq34538__$1);
var seq34538__$2 = cljs.core.next(seq34538__$1);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34539,G__34540,seq34538__$2);
}));
...
var iter__4564__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__34553(s__34554){
return (new cljs.core.LazySeq(null,(function (){
var s__34554__$1 = s__34554;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__34554__$1);
if(temp__5735__auto__){
var s__34554__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34554__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__34554__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__34556 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__34555 = (0);
while(true){
if((i__34555 < size__4563__auto__)){
var vec__34557 = cljs.core._nth(c__4562__auto__,i__34555);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34557,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34557,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__34556,id);

var G__34583 = (i__34555 + (1));
i__34555 = G__34583;
continue;
} else {
var G__34584 = (i__34555 + (1));
i__34555 = G__34584;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34556),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__34553(cljs.core.chunk_rest(s__34554__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34556),null);
}
} else {
var vec__34560 = cljs.core.first(s__34554__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34560,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34560,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__34553(cljs.core.rest(s__34554__$2)));
} else {
var G__34588 = cljs.core.rest(s__34554__$2);
s__34554__$1 = G__34588;
continue;
}
}
} else {
